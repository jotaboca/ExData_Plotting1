...
sub1 <- ts(my_data2$Sub_metering_1)
sub2 <- ts(my_data2$Sub_metering_2)
sub3 <- ts(my_data2$Sub_metering_3)
ts.plot(sub1, sub2, sub3, xlab="", ylab="Energy sub metering",
        gpars=list(xaxt="n", col=c("black", "red", "blue")))
